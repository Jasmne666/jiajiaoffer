...
IMAGES = [
    ...
    ImageItem("推文作品/寒招推文/寒招推文1.png", "深圳大学寒招推文 01", "推文作品", "校园宣发", True),
    ImageItem("推文作品/寒招推文/寒招推文2.png", "深圳大学寒招推文 02", "推文作品", "校园宣发"),
    ImageItem("推文作品/寒招推文/寒招3.png", "深圳大学寒招推文 03", "推文作品", "校园宣发"),
    ImageItem("推文作品/cnad推文作品/推文作品1.png", "CNAD 活动推文 01", "推文作品", "活动传播", True),
    ImageItem("推文作品/cnad推文作品/推文作品2.png", "CNAD 活动推文 02", "推文作品", "活动传播"),
    ImageItem("推文作品/cnad推文作品/推文作品3.png", "CNAD 活动推文 03", "推文作品", "活动传播"),
    ImageItem("推文作品/cnad推文作品/推文作品4.png", "CNAD 活动推文 04", "推文作品", "活动传播"),
    ImageItem("物料设计/海报1.png", "节日主题海报", "物料设计", "海报设计"),
    ImageItem("物料设计/海报2.png", "饮品主题海报", "物料设计", "海报设计", True),
    ImageItem("物料设计/海报3.png", "音乐节主题海报", "物料设计", "海报设计"),
    ImageItem("物料设计/海报4.png", "公益主题海报", "物料设计", "海报设计"),
    ImageItem("物料设计/CNAD活动物料/活动海报.png", "CNAD 活动海报", "物料设计", "活动视觉", True),
    ImageItem("物料设计/CNAD活动物料/活动物料1.png", "CNAD 活动物料 01", "物料设计", "活动视觉"),
    ImageItem("物料设计/CNAD活动物料/活动物料2.png", "CNAD 活动物料 02", "物料设计", "活动视觉"),
    ImageItem("物料设计/CNAD活动物料/活动物料3.png", "CNAD 活动物料 03", "物料设计", "活动视觉"),
    ImageItem("物料设计/雀巢商赛/ui设计.png", "雀巢商赛 UI 方案 01", "物料设计", "商业竞赛"),
    ImageItem("物料设计/雀巢商赛/ui设计2.png", "雀巢商赛 UI 方案 02", "物料设计", "商业竞赛"),
    ImageItem("物料设计/雀巢商赛/ui设计3.png", "雀巢商赛 UI 方案 03", "物料设计", "商业竞赛"),
    ImageItem("物料设计/雀巢商赛/包装设计.png", "雀巢商赛包装设计", "物料设计", "商业竞赛", True),
    ImageItem("物料设计/雀巢商赛/包装设计六视图.png", "包装设计六视图", "物料设计", "商业竞赛"),
    ImageItem("物料设计/雀巢商赛/包装设计平面图.png", "包装设计平面图 01", "物料设计", "商业竞赛"),
    ImageItem("物料设计/雀巢商赛/包装设计平面图2.png", "包装设计平面图 02", "物料设计", "商业竞赛"),
    ...
    ImageItem("摄影作品/自然风景摄影/摄影1.png", "风景摄影 01", "摄影作品", "风景摄影", True),
    ImageItem("摄影作品/自然风景摄影/摄影2.png", "风景摄影 02", "摄影作品", "风景摄影"),
    ImageItem("摄影作品/自然风景摄影/摄影3.png", "风景摄影 03", "摄影作品", "风景摄影"),
    ImageItem("摄影作品/自然风景摄影/摄影4.png", "风景摄影 04", "摄影作品", "风景摄影"),
]
...
DOCS = [
    ...
    DocItem("策划案作品/雀巢商赛鲜味周历.pdf", "雀巢商赛鲜味周历", "PDF", "商业竞赛策划案"),
